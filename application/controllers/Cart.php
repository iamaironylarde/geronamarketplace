        ...
        switch ($txn) {
            ...
            case 'create':
                ...
                $temp = $m_cart->get_list(
                  'cart.user_id='.$user_id.'  AND cart.is_reserve=0 AND cart.product_id='.$product_id,
                  'cart.cart_id,cart.quantity,products.qty',
                array(
            ...
            case 'createtoreserve':
                ...
                if(count($temp)==0){
                  ...
                  $m_products->set('qty','qty+'.$unit_id);
            ...
            case 'createreserve':
                ...
                $unit_id = $this->input->post('unit_id', TRUE);
                $temp = $m_cart->get_list(
                  'cart.user_id='.$user_id.' AND cart.is_reserve=1 AND cart.product_id='.$product_id,
                  'cart.cart_id,cart.quantity,products.qty',
                array(
                          array('products','products.product_id=cart.product_id','left'),
                          array('category','category.category_id=products.category_id','left'),
